...
INSERT INTO sys_menu (pid, name, url, authority, type, open_style, icon, sort, version, deleted, creator, create_time, updater, update_time) VALUES ((SELECT @menuId), 'Java监控', '{{apiUrl}}/monitor/admin', null, 0, 0, 'icon-pointmap', 1, 0, 0, 10000, now(), 10000, now());
